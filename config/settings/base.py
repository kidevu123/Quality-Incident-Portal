...
MIDDLEWARE = [
    ...
    "apps.accounts.middleware.ActivateUserTimezoneMiddleware",
...
LANGUAGE_CODE = "en-us"
# Default display / Celery clock: US Eastern (handles EST/EDT). Users may set IANA zone in preferences["timezone"].
